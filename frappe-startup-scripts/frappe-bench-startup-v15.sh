...
nvm deactivate && nvm install 18 && nvm use 18 && nvm alias default 18 && nvm alias default node || return 1
...
frappe_prepare_bench 15 "/home/frappe/.pyenv/shims/python" || return 1
